// 由 DeployHelper.php 自动导出的部署商元数据
    ...
    "taskinputs": {
      "format": {
        ...
        "options": [
          {
            "value": "pem",
            "label": "PEM格式（Nginx/Apache等）"
          },
          {
            "value": "pfx",
            "label": "PFX格式（IIS/Tomcat）"
          }
        ],
        "value": "pem",
        "required": true
...
export const deployClassConfig: Record<number, string> = {"1":"自建系统","2":"云服务商","3":"服务器"};
